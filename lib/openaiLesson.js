...
Start your response with the opening brace {`;
  ...
  if (lesson?.slides) {
    lesson.slides = lesson.slides.map((slide) => {
      ...
      // Ensure bullets array is not empty for display
  ...
  console.log(`[buildLessonWithAI] Final result: ${finalSlideCount} slides generated (requested: ${requestedSlideCount || 'default'})`);
